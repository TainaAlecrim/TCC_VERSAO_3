...
class UserFormHosp extends StatefulWidget {
  final User user;
  final state = _UserFormState();
  final OnDelete onDelete;

  UserFormHosp({Key key, this.user, this.onDelete}) : super(key: key);
  @override
...
class _UserFormState extends State<UserFormHosp> {
                ...
                actions: <Widget>[
                  FlatButton(
                      ...
                      onPressed: () {
                        ...
                        Map<String, dynamic> Hospitalizacoes = {
                        ...
                        crudObj
                            .addHospitalizacoes(Hospitalizacoes)
                            .then((result) {
